...
export default function Landingpage() {
    ...
    */
  return (
    <div className="bg-[#211F27] text-white text-sm h-[100%] flex-col justify-center items-center gap-10">
     

      {/* Section One */}
      <div className="w-full relative bg-[url('/images/backgroundurl.png')] bg-no-repeat bg-cover  h-[70%] md:h-[100%]">
         <Header />

         
         <div className="flex pl-10 md:px-24 z-[5555]  ">

            <div className="z-[1000000000] pt-10 w-full">
        ...
        {/* Section two */}
        <div id='about' className="relative bg-[#211F27] flex justify-center items-center z-[99999] h-[70%] md:h-[100%]">
          <div className="p-8 md:mt-[80px] bg-[url('/images/ABOUT.png')] bg-no-repeat bg-top bg-contain md:bg-auto flex justify-center items-center">

            <div className="flex-flex-col justify-start items-start w-[100%] md:w-[75%] px-0 md:px-20 mt-10">

              <div className="text-[24px] font-semibold text-[#E81CFF] my-5">WHAT‘S Streamifi</div>
              <div className="text-[24px] font-bold mb-5">The decentralized trading & music streaming <br/> platform on Web 3.0</div>
              <div className="">Streamifi brings DeFi and trading to the music industry. It enables creators to tokenize their name/brand, content, and songs; allowing fans to buy, sell, trade and promote these tokens directly in real time on the blockchain while also sharing streaming earnings.</div>
        ...
        {/* Section three */}
        <div className=" bg-[#211F27] flex justify-center items-center z-[99999] h-[70%] md:h-[100%] ">
        ...
        {/* Section Four */}
        <div className="bg-[#211F27] z-[99999] h-[70%] md:h-[100%] ">
        ...
        {/* Section Five */}
        <div className="relative bg-[#211F27] flex justify-center items-center z-[99999] h-[70%] md:h-[100%]">
 
          <div className="p-8 md:mt-[80px] bg-[url('/images/ROADMAP.png')] bg-no-repeat bg-top bg-contain md:bg-auto flex justify-center items-center w-full ">

              <div className="flex flex-col justify-center items-center w-[100%] md:w-[75%] p-20 mt-10">
                    
                <ul class="flex  p-1 bg-[#000] rounded-full shadow-lg">
                      <li class="nc-NavItem2 relative" data-nc-id="NavItem2">
                          <button className="block font-medium whitespace-nowrap px-3 py-2 text-sm sm:px-7 sm:py-3 capitalize rounded-full bg-primary-6000 text-primary-50 focus:outline-none bg-[#553CDF]">
                                <div className="flex items-center justify-center sm:space-x-2.5 text-xs sm:text-sm">
                                  <span className="hidden sm:inline-block"> 
